          ...
          <cardBody>
            <v-row>
              <v-col :sm="9" :lg="10" align="left">
                <div class="form-group-wrap">
                  <div class="form-group">
                    <label>{{ $t("RoleMngPage.label1") }}</label>
                    <InputText
                      :searchOption="true"
                      :dataNm="'roleId'"
                      :boxWidth="'90%'"
                  ...
                  <div class="form-group">
                    <label>{{ $t("RoleMngPage.label2") }}</label>
                    <InputText
                      :searchOption="true"
                      :dataNm="'roleNm'"
                      :boxWidth="'90%'"
              ...
              <v-col :sm="3" :lg="2" align="right">
                <kbutton :theme-color="'primary'" :size="'medium'" @click="search">
                  {{ $t("CommLang.btn.selectBtn") }}
                </kbutton>
              </v-col>
            </v-row>
          </cardBody>
          ...
          <cardBody>
            <v-row>
              ...
              <v-col cols="9" align="right">
                <kbutton :theme-color="'primary'" :size="'small'" :icon="'save'" @click="rowGridSave">
                  {{ $t("CommLang.btn.saveBtn") }}
                </kbutton>
                <kbutton :theme-color="'secondary'" :size="'small'" :icon="'add'" @click="insert">
                  {{ $t("CommLang.btn.addBtn")}}
                </kbutton>
                <kbutton :theme-color="'secondary'" :size="'small'" :icon="'delete'" @click="remove">
                  {{ $t("CommLang.btn.removeBtn") }}
                </kbutton>
...
export default {
  ...
  methods: {
    ...
    formInputValSet(nm, val) {
      ...
      if (this.selectedData.rowStat == "N") {
        this.selectedData.rowStat = "U";
      }
      this.gridData.splice(this.selectedData.idx, 1, this.selectedData);
    },
    ...
    gridInit() {
      this.columns = [
        { field: 'rowStat', editable: false, title: " ", width: this.setPer("divWrapper", 13), cell:"crudCellTemplate", className: "gridTextCenter"},
        { field: "roleId", editable: false, title: this.label1, width: this.setPer("divWrapper", 42) },
        { field: "roleNm", editable: false, title: this.label2, width: this.setPer("divWrapper", 42) },
    ...
    async onRowClick(event) {
      if (event.dataItem) {
        ...
        this.$refs["rmrk"].textVal = event.dataItem.rmrk
          ? event.dataItem.rmrk
          : "";
    ...
    async rowGridSave() {
      ...
      this.gridData.filter((item) => {
        if (item.rowStat == "C" || item.rowStat == "U") {
          dataArr.push(item);
        }
        if (item.rowStat == "C") {
