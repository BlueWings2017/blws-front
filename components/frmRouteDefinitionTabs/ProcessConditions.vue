          ...
          <v-col cols="12">
            <div class="form-group-wrap form-group-style2">
              ...
              <div class="form-group">
                <Label>공정조건명</Label>
                <InputText
                  ref="recipeparametername"
                  :dataNm="'recipeparametername'"
                  :disabled="false"
                  @input-text-set="searchInput"
                  :searchOption="true"
                  :searchFunc="searchBtn"
              ...
              <div class="form-group">
                <Label>공정조건군</Label>
                <MesSelectBox
                  :enumID="'RecipeParameterGroup'"
                  :allYN="true"
                  :dataNm="'recipeparametergroup'"
...
export default {
  ...
  data() {
    return {
      ...
      gridOriData : [],
      gridDropDownList:[
        {dataVal : 'RECIPEPARAMETERGROUP',dataItem: []},
        {dataVal : 'RECIPEPARAMETERTYPE',dataItem: []},
  ...
  methods: {
    ...
    addBtn(){
      ...
      const dataItem = { 
        ...
        RECIPEPARAMETERID: "", 
        RECIPEPARAMETERNAME: "", 
        RECIPEPARAMETERGROUP: "Temperature", 
    ...
    delConfirm(){
      ...
      if(chk.length == 0 && this.newRowChk.length == 0) { // 체크한 행 없을 때
        ...
        this.$refs.alertPop.message = '선택한 데이터가 없습니다. 삭제할 데이터를 선택해 주시기 바랍니다.';
        ...
        this.$refs.ConfirmPop.message = '선택한 데이터'+message+'를 삭제 하시겠습니까?';
